...
constexpr std::array<Dispatcher, 256> DefineGenericTable()
{
    ...
    t[0b00000100] = D_CMP_G_imm8_EAd<Sz, Mode>;
    t[0b00000101] = D_CMP_G_imm16_EAd<Sz, Mode>;
    t[0b00000110] = D_MOV_G_imm8_EAd<Sz, Mode>;
    t[0b00000111] = D_MOV_G_imm16_EAd<Sz, Mode>;
    t[0b00001000] = D_ADD_Q_n_EAd<Sz, Mode, 1>;
    t[0b00001001] = D_ADD_Q_n_EAd<Sz, Mode, 2>;
    t[0b00001010] = nullptr;
    t[0b00001011] = nullptr;
    t[0b00001100] = D_ADD_Q_n_EAd<Sz, Mode, -1>;
    t[0b00001101] = D_ADD_Q_n_EAd<Sz, Mode, -2>;
    ...
    t[0b01001000] = D_BSET_Rs_EAd<Sz, 0, Mode>;
    t[0b01001001] = D_BSET_Rs_EAd<Sz, 1, Mode>;
    t[0b01001010] = D_BSET_Rs_EAd<Sz, 2, Mode>;
    t[0b01001011] = D_BSET_Rs_EAd<Sz, 3, Mode>;
    t[0b01001100] = D_BSET_Rs_EAd<Sz, 4, Mode>;
    t[0b01001101] = D_BSET_Rs_EAd<Sz, 5, Mode>;
    t[0b01001110] = D_BSET_Rs_EAd<Sz, 6, Mode>;
    t[0b01001111] = D_BSET_Rs_EAd<Sz, 7, Mode>;
    ...
    t[0b01011000] = D_BCLR_Rs_EAd<Sz, 0, Mode>;
    t[0b01011001] = D_BCLR_Rs_EAd<Sz, 1, Mode>;
    t[0b01011010] = D_BCLR_Rs_EAd<Sz, 2, Mode>;
    t[0b01011011] = D_BCLR_Rs_EAd<Sz, 3, Mode>;
    t[0b01011100] = D_BCLR_Rs_EAd<Sz, 4, Mode>;
    t[0b01011101] = D_BCLR_Rs_EAd<Sz, 5, Mode>;
    t[0b01011110] = D_BCLR_Rs_EAd<Sz, 6, Mode>;
    t[0b01011111] = D_BCLR_Rs_EAd<Sz, 7, Mode>;
    ...
    t[0b01110000] = D_CMP_G_EAs_Rd<Sz, 0, Mode>;
    t[0b01110001] = D_CMP_G_EAs_Rd<Sz, 1, Mode>;
    t[0b01110010] = D_CMP_G_EAs_Rd<Sz, 2, Mode>;
    t[0b01110011] = D_CMP_G_EAs_Rd<Sz, 3, Mode>;
    t[0b01110100] = D_CMP_G_EAs_Rd<Sz, 4, Mode>;
    t[0b01110101] = D_CMP_G_EAs_Rd<Sz, 5, Mode>;
    t[0b01110110] = D_CMP_G_EAs_Rd<Sz, 6, Mode>;
    t[0b01110111] = D_CMP_G_EAs_Rd<Sz, 7, Mode>;
    t[0b01111000] = D_BTST_Rs_EAd<Sz, 0, Mode>;
    t[0b01111001] = D_BTST_Rs_EAd<Sz, 1, Mode>;
    t[0b01111010] = D_BTST_Rs_EAd<Sz, 2, Mode>;
    t[0b01111011] = D_BTST_Rs_EAd<Sz, 3, Mode>;
    t[0b01111100] = D_BTST_Rs_EAd<Sz, 4, Mode>;
    t[0b01111101] = D_BTST_Rs_EAd<Sz, 5, Mode>;
    t[0b01111110] = D_BTST_Rs_EAd<Sz, 6, Mode>;
    t[0b01111111] = D_BTST_Rs_EAd<Sz, 7, Mode>;
    ...
    t[0b10010000] = D_MOV_G_Rs_EAd<Sz, 0, Mode>;
    t[0b10010001] = D_MOV_G_Rs_EAd<Sz, 1, Mode>;
    t[0b10010010] = D_MOV_G_Rs_EAd<Sz, 2, Mode>;
    t[0b10010011] = D_MOV_G_Rs_EAd<Sz, 3, Mode>;
    t[0b10010100] = D_MOV_G_Rs_EAd<Sz, 4, Mode>;
    t[0b10010101] = D_MOV_G_Rs_EAd<Sz, 5, Mode>;
    t[0b10010110] = D_MOV_G_Rs_EAd<Sz, 6, Mode>;
    t[0b10010111] = D_MOV_G_Rs_EAd<Sz, 7, Mode>;
    t[0b10011000] = D_STC_CR_EAd<Sz, 0, Mode>;
    t[0b10011001] = D_STC_CR_EAd<Sz, 1, Mode>;
    t[0b10011010] = D_STC_CR_EAd<Sz, 2, Mode>;
    t[0b10011011] = D_STC_CR_EAd<Sz, 3, Mode>;
    t[0b10011100] = D_STC_CR_EAd<Sz, 4, Mode>;
    t[0b10011101] = D_STC_CR_EAd<Sz, 5, Mode>;
    t[0b10011110] = D_STC_CR_EAd<Sz, 6, Mode>;
    t[0b10011111] = D_STC_CR_EAd<Sz, 7, Mode>;
    ...
    t[0b11000000] = D_BSET_imm4_EAd<Sz, 0, Mode>;
    t[0b11000001] = D_BSET_imm4_EAd<Sz, 1, Mode>;
    t[0b11000010] = D_BSET_imm4_EAd<Sz, 2, Mode>;
    t[0b11000011] = D_BSET_imm4_EAd<Sz, 3, Mode>;
    t[0b11000100] = D_BSET_imm4_EAd<Sz, 4, Mode>;
    t[0b11000101] = D_BSET_imm4_EAd<Sz, 5, Mode>;
    t[0b11000110] = D_BSET_imm4_EAd<Sz, 6, Mode>;
    t[0b11000111] = D_BSET_imm4_EAd<Sz, 7, Mode>;
    t[0b11001000] = D_BSET_imm4_EAd<Sz, 8, Mode>;
    t[0b11001001] = D_BSET_imm4_EAd<Sz, 9, Mode>;
    t[0b11001010] = D_BSET_imm4_EAd<Sz, 10, Mode>;
    t[0b11001011] = D_BSET_imm4_EAd<Sz, 11, Mode>;
    t[0b11001100] = D_BSET_imm4_EAd<Sz, 12, Mode>;
    t[0b11001101] = D_BSET_imm4_EAd<Sz, 13, Mode>;
    t[0b11001110] = D_BSET_imm4_EAd<Sz, 14, Mode>;
    t[0b11001111] = D_BSET_imm4_EAd<Sz, 15, Mode>;
    t[0b11010000] = D_BCLR_imm4_EAd<Sz, 0, Mode>;
    t[0b11010001] = D_BCLR_imm4_EAd<Sz, 1, Mode>;
    t[0b11010010] = D_BCLR_imm4_EAd<Sz, 2, Mode>;
    t[0b11010011] = D_BCLR_imm4_EAd<Sz, 3, Mode>;
    t[0b11010100] = D_BCLR_imm4_EAd<Sz, 4, Mode>;
    t[0b11010101] = D_BCLR_imm4_EAd<Sz, 5, Mode>;
    t[0b11010110] = D_BCLR_imm4_EAd<Sz, 6, Mode>;
    t[0b11010111] = D_BCLR_imm4_EAd<Sz, 7, Mode>;
    t[0b11011000] = D_BCLR_imm4_EAd<Sz, 8, Mode>;
    t[0b11011001] = D_BCLR_imm4_EAd<Sz, 9, Mode>;
    t[0b11011010] = D_BCLR_imm4_EAd<Sz, 10, Mode>;
    t[0b11011011] = D_BCLR_imm4_EAd<Sz, 11, Mode>;
    t[0b11011100] = D_BCLR_imm4_EAd<Sz, 12, Mode>;
    t[0b11011101] = D_BCLR_imm4_EAd<Sz, 13, Mode>;
    t[0b11011110] = D_BCLR_imm4_EAd<Sz, 14, Mode>;
    t[0b11011111] = D_BCLR_imm4_EAd<Sz, 15, Mode>;
    t[0b11100000] = D_BNOT_imm4_EAd<Sz, 0, Mode>;
    t[0b11100001] = D_BNOT_imm4_EAd<Sz, 1, Mode>;
    t[0b11100010] = D_BNOT_imm4_EAd<Sz, 2, Mode>;
    t[0b11100011] = D_BNOT_imm4_EAd<Sz, 3, Mode>;
    t[0b11100100] = D_BNOT_imm4_EAd<Sz, 4, Mode>;
    t[0b11100101] = D_BNOT_imm4_EAd<Sz, 5, Mode>;
    t[0b11100110] = D_BNOT_imm4_EAd<Sz, 6, Mode>;
    t[0b11100111] = D_BNOT_imm4_EAd<Sz, 7, Mode>;
    t[0b11101000] = D_BNOT_imm4_EAd<Sz, 8, Mode>;
    t[0b11101001] = D_BNOT_imm4_EAd<Sz, 9, Mode>;
    t[0b11101010] = D_BNOT_imm4_EAd<Sz, 10, Mode>;
    t[0b11101011] = D_BNOT_imm4_EAd<Sz, 11, Mode>;
    t[0b11101100] = D_BNOT_imm4_EAd<Sz, 12, Mode>;
    t[0b11101101] = D_BNOT_imm4_EAd<Sz, 13, Mode>;
    t[0b11101110] = D_BNOT_imm4_EAd<Sz, 14, Mode>;
    t[0b11101111] = D_BNOT_imm4_EAd<Sz, 15, Mode>;
    t[0b11110000] = D_BTST_imm4_EAd<Sz, 0, Mode>;
    t[0b11110001] = D_BTST_imm4_EAd<Sz, 1, Mode>;
    t[0b11110010] = D_BTST_imm4_EAd<Sz, 2, Mode>;
    t[0b11110011] = D_BTST_imm4_EAd<Sz, 3, Mode>;
    t[0b11110100] = D_BTST_imm4_EAd<Sz, 4, Mode>;
    t[0b11110101] = D_BTST_imm4_EAd<Sz, 5, Mode>;
    t[0b11110110] = D_BTST_imm4_EAd<Sz, 6, Mode>;
    t[0b11110111] = D_BTST_imm4_EAd<Sz, 7, Mode>;
    t[0b11111000] = D_BTST_imm4_EAd<Sz, 8, Mode>;
    t[0b11111001] = D_BTST_imm4_EAd<Sz, 9, Mode>;
    t[0b11111010] = D_BTST_imm4_EAd<Sz, 10, Mode>;
    t[0b11111011] = D_BTST_imm4_EAd<Sz, 11, Mode>;
    t[0b11111100] = D_BTST_imm4_EAd<Sz, 12, Mode>;
    t[0b11111101] = D_BTST_imm4_EAd<Sz, 13, Mode>;
    t[0b11111110] = D_BTST_imm4_EAd<Sz, 14, Mode>;
