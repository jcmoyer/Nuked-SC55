...
constexpr std::array<std::array<D_OpcodeHandler, 256>, 2> DECODE_TABLES_D8{{
    DefineGenericTable<MCU_Operand_Size::BYTE, Mode_d8_Rn>(),
    DefineGenericTable<MCU_Operand_Size::WORD, Mode_d8_Rn>(),
}};

constexpr std::array<std::array<D_OpcodeHandler, 256>, 2> DECODE_TABLES_D16{{
    DefineGenericTable<MCU_Operand_Size::BYTE, Mode_d16_Rn>(),
    DefineGenericTable<MCU_Operand_Size::WORD, Mode_d16_Rn>(),
}};
